      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <p className="tex-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I develop secure, scalable systems by combining front-end
            development, cloud automation, and cybersecurity, leveraging AI to
            enhance performance and infrastructure resilience.
          </p>
